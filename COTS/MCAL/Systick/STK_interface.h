 ...
 * @brief Functions that are used for controlling the SysTick timer.
 * @{
 */
/**
 ...
 * the reload value of the SysTick timer.
 *
 * @param[in] Copy_Milliseconds The number of milliseconds to wait. This value could be any Integer number.
 *
 *@note it Calls STK_wait Function Implicitly
 * @return E_OK if the delay was successful, E_NOT_OK if an error occurred.
 */
